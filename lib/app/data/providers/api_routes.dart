...
abstract class ApiUrl {
  ...
  static String membershipPackageDetail(int id) => '$baseUrl/membership/packages/$id';
  ...
  static String updateMembershipStatus(int id) => '$baseUrl/membership/status/$id';
  ...
  static String updateMembershipPackage(int id) => '$baseUrl/membership/packages/$id';
  static String deleteMembershipPackage(int id) => '$baseUrl/membership/packages/$id';
  ...
  static String gymClassSchedules(int classId) => '$baseUrl/gym-classes/$classId/schedules';
  ...
  static String createGymClassSchedule(int classId) => '$baseUrl/gym-classes/$classId/schedules';
  static String updateGymClassSchedule(int classId, int scheduleId) => '$baseUrl/gym-classes/$classId/schedules/$scheduleId';
  static String deleteGymClassSchedule(int classId, int scheduleId) => '$baseUrl/gym-classes/$classId/schedules/$scheduleId';
  static const String bookClass = '$baseUrl/gym-classes/book';
  static String cancelBooking(int attendanceId) => '$baseUrl/gym-classes/bookings/$attendanceId';
  static const String myBookings = '$baseUrl/gym-classes/my-bookings';
  static String markAttendance(int attendanceId) => '$baseUrl/gym-classes/attendance/$attendanceId';
  ...
  static String trainerPackagesByTrainer(int trainerId) => '$baseUrl/trainers/$trainerId/packages';
  static const String createTrainerPackage = '$baseUrl/trainers/packages';
  static String updateTrainerPackage(int packageId) => '$baseUrl/trainers/packages/$packageId';
  static String deleteTrainerPackage(int packageId) => '$baseUrl/trainers/packages/$packageId';
  static const String purchaseTrainerPackage = '$baseUrl/trainers/packages/purchase';
  static const String trainerAssignments = '$baseUrl/trainers/assignments';
  static String trainerAssignmentsByTrainer(int trainerId) => '$baseUrl/trainers/$trainerId/assignments';
  static String trainerAssignmentDetail(int assignmentId) => '$baseUrl/trainers/assignments/$assignmentId';
  static const String trainerSchedules = '$baseUrl/trainers/schedules';
  static String trainerSchedulesByTrainer(int trainerId) => '$baseUrl/trainers/$trainerId/schedules';
  static const String createTrainerSchedule = '$baseUrl/trainers/schedules';
  static String updateTrainerSchedule(int scheduleId) => '$baseUrl/trainers/schedules/$scheduleId';
  static const String trainersStatistics = '$baseUrl/trainers/statistics';
  static String trainerStatistics(int trainerId) => '$baseUrl/trainers/$trainerId/statistics';
  ...
  static const String gymVisitsStatisticsAdmin = '$baseUrl/gym-visits/statistics/admin';
  static const String myGymVisitsStatistics = '$baseUrl/gym-visits/statistics/my-stats';
  ...
  static String transactionDetail(int id) => '$baseUrl/payments/transactions/$id';
  ...
  static const String paymentTrainerPackage = '$baseUrl/payments/trainer-package';
  static String checkPaymentStatus(int transactionId) => '$baseUrl/payments/status/$transactionId';
  static String cancelPayment(int transactionId) => '$baseUrl/payments/cancel/$transactionId';
  static String manualApproval(int transactionId) => '$baseUrl/payments/manual-approval/$transactionId';
